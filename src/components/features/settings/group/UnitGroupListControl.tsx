...
import { ICON_DAY_CHECK, ICON_DAY_EDIT, ICON_DAY_UNDO, SIZESET_DEFAULT_INPUT_HEIGHT,  } from '@/config/constSet';
...
import { ViewModeProp } from '@/types/types';
    ...
    <GroupContainer>
      <ListContainer>
        ...
        {unitGroupSlice.groups.length > 0
          ? unitGroupSlice.groups.map((_, index:number) => (
