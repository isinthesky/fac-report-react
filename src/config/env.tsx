...
export const INIT_REPORT_MENU1 = getEnvVar('VITE_APP_INIT_REPORT_MENU1');

export const INIT_REPORT_MENU1_SUB1 = getEnvVar('VITE_APP_INIT_REPORT_MENU1_SUB1');
export const INIT_REPORT_MENU1_SUB2 = getEnvVar('VITE_APP_INIT_REPORT_MENU1_SUB2');
